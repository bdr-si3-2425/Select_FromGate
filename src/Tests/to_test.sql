...
CREATE OR REPLACE VIEW Abonnes_Exemplaires AS
...
CREATE OR REPLACE  VIEW Vue_Bibliotheques_Bibliothecaires AS
SELECT DISTINCT b.*
...
CREATE OR REPLACE VIEW Vue_Reservations_Bibliothecaires AS
SELECT r.*
FROM Reservations r
...
VALUES 
  (1, 1, 'Littérature', 'Rencontre avec un auteur', '2025-03-15', 50, 10),
