...
VALUES (1, 1, CURRENT_DATE, CURRENT_DATE + INTERVAL '7 days'); -- Doit echouer

-- Vérifier si un abonné peut mettre à jour sa réservation
UPDATE Reservations SET date_expiration = CURRENT_DATE + INTERVAL '10 days' WHERE id_abonne = 1; -- Doit échouer
